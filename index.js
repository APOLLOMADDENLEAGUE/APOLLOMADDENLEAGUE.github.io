...
const statConfig = {
  ...
  defense:{title:'Defensive Leaders',sort:'defTotalTackles',line:r=>`${r.fullName} — **${n(r.defTotalTackles)} TKL** | ${n(r.defSacks)} SACK | ${n(r.defInts)} INT | ${n(r.defTDs)} TD`},
...
const exactStats={passTDs:['passing','Passing Touchdowns','TD'],passInts:['passing','Passing Interceptions','INT'],rushTDs:['rushing','Rushing Touchdowns','TD'],recCatches:['receiving','Receptions','REC'],recTDs:['receiving','Receiving Touchdowns','TD'],defTotalTackles:['defense','Total Tackles','TKL'],defSacks:['defense','Sacks','SACK'],defInts:['defense','Defensive Interceptions','INT'],defTDs:['defense','Defensive Touchdowns','TD'],defForcedFum:['defense','Forced Fumbles','FF']};
...
async function recordsReply(type,category){
  const definitions={passing:[['passYds','Passing Yards','YDS'],['passTDs','Passing Touchdowns','TD']],rushing:[['rushYds','Rushing Yards','YDS'],['rushTDs','Rushing Touchdowns','TD']],receiving:[['recCatches','Receptions','REC'],['recYds','Receiving Yards','YDS'],['recTDs','Receiving Touchdowns','TD']],defense:[['defTotalTackles','Tackles','TKL'],['defSacks','Sacks','SACK'],['defInts','Interceptions','INT'],['defTDs','Defensive Touchdowns','TD']],kicking:[['kickPts','Kicking Points','PTS'],['fGLongest','Longest Field Goal','YDS']]};
